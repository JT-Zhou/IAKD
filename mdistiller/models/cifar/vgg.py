...
if __name__ == "__main__":
    ...
    net = vgg13(num_classes=200)
    # checkpoint = "https://download.pytorch.org/models/vgg13-c768596a.pth"
    # net.load_state_dict(torch.hub.load_state_dict_from_url(checkpoint, progress=False))
    logit, feats = net(x)
    print(net)

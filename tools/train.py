...
if __name__ == "__main__":
    ...
    parser.add_argument("--cfg", type=str, default=r"G:\Python Prog\github\IAKD\configs\cifar100\IAKD/res32x4_8x4.yaml")#dkd\res56x4_res20x4.yamlvgg/iakd.yaml

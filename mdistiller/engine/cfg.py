...
CFG.SOLVER.WEIGHT_DECAY = 0.1#0.0001
...
# AN CFG
CFG.AN = CN()
CFG.AN.TEMPERATURE = 4.0
CFG.AN.T_MAX = 8.0
CFG.AN.T = 4.0
CFG.AN.LOSS = CN()
CFG.AN.LOSS.CE_WEIGHT = 0.1
CFG.AN.LOSS.KD_WEIGHT = 0.9
...
# IAKD CFG
CFG.IAKD = CN()
CFG.IAKD.CE_WEIGHT = 1.0
CFG.IAKD.FeatureKD_WEIGHT = 3.0
CFG.IAKD.KD_WEIGHT = 5.0
CFG.IAKD.WARMUP_EPOCHS = 20
CFG.IAKD.SHAPES = [1,4,8,16]
CFG.IAKD.OUT_SHAPES = [1, 8, 16, 32]
CFG.IAKD.IN_CHANNELS = [116,232,464,1024]
CFG.IAKD.OUT_CHANNELS = [32,64,128,128]
CFG.IAKD.MAX_MID_CHANNEL = 512
CFG.IAKD.STU_PREACT = False
CFG.IAKD.A = 3
CFG.IAKD.B = 6
CFG.IAKD.T_MAX = 9.0
CFG.IAKD.T_MIN = 6.0
